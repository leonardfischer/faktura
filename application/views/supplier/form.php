				...
				<div class="col-sm-6">
					...
					<div class="form-group" data-property="<?=$key ?>">
						...
						<div class="col-md-8">
							...
							{
								echo '<div class="input-group"><span class="input-group-addon"><i class="fa fa-euro"></i></span>' . Form::input('input' . ucfirst($key), $supplier->get($key), array('type' => 'text', 'placeholder' => $property['label'], 'class' => 'form-control money')) . '</div>';
							}
