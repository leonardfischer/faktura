<div class="row">
	<div class="col-xs-6">
		<a class="btn btn-success" href="<?=Route::url('supplier', array('action' => 'new')) ?>"><i class="icon-plus icon-white"></i> <?=__('Create new supplier') ?></a>
	</div>
	<div class="col-xs-6">
		<form>
...
<script type="text/javascript">
	var pager_items = parseInt('<?=$count ?>'),
		...
		supplier_table_search = new AjaxTableSearch($('form-ajax-search'), $('supplier-list'), {
			...
			nothing_found_label: '<i class="mr5 icon-info-sign"></i><?=__('Sorry - no suppliers were found!') ?>',
